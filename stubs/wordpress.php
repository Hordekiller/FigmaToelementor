...
if (!function_exists('wp_remote_get')) { function wp_remote_get(...$args): array|object { return []; } }
...
if (!function_exists('is_wp_error')) { function is_wp_error(...$args): bool { return false; } }
